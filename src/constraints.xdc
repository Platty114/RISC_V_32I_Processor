...
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 5.00} -add [get_ports clk_100]
...
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports  display_switch ]; #IO_L21P_T3_DQS_14 Sch=sw[15]
